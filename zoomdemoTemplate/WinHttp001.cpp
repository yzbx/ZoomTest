...
std::string WinHttp001::WStringToString(const std::wstring &wstr)
{
	std::string str = "";
...
std::string WinHttp001::WinHttpPost(std::map<std::string, std::wstring> param_map)
{
